...
export default class Transportadora implements ITransportadora{
    ...
    send(): string {
        ...
        console.log("Transportadora: pacote recebido e pronto para iniciar entrega para o destinatário, código de rastreio: " + this._trackingCode);
        return this._trackingCode;
    }
    receive(): string {
        this.generateTrackingCode();
        console.log("Transportadora: entrega autorizada, pacote saindo para entrega até você, código de rastreio: " + this._trackingCode);
        return this._trackingCode;
    }
}